...
object InputWidth {
  ...
  case object ThreeQuarters
      extends WithCssClass("govuk-!-width-three-quarters")
      with InputWidth
  case object TwoThirds
      extends WithCssClass("govuk-!-width-two-thirds")
      with InputWidth
  case object OneHalf extends WithCssClass("govuk-!-width-one-half") with InputWidth
  case object OneThird
      extends WithCssClass("govuk-!-width-one-third")
      with InputWidth
  case object OneQuarter
      extends WithCssClass("govuk-!-width-one-quarter")
      with InputWidth
}
